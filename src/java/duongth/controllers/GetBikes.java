...
public class GetBikes extends HttpServlet {
    ...
    Connection conn = db.makeConnection(); // Kết nối Database
    BikeDAO bikeDAO = new BikeDAO(conn);
    List<Bike> bikes = bikeDAO.getAllBikes();

    request.setAttribute("Bike", bikes); // Đặt danh sách vào request
    request.getRequestDispatcher("viewBikes.jsp").forward(request, response);
}
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetBikes.class.getName()).log(Level.SEVERE, null, ex);
        }
